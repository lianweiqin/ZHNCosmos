...
- (YYLabel *)screen_nameLabel
{
    if(_screen_nameLabel == nil)
    {
        ...
        screen_nameLabel.font = [UIFont systemFontOfSize:14];
...
- (KILabel *)textPostLabel
{
    if(_textPostLabel == nil)
    {
        ...
        textPostLabel.preferredMaxLayoutWidth = viewWidth() - 2 * margin;
        textPostLabel.backgroundColor = RandomColor;
...
- (UILabel *)created_atTimeLabel
{
    if(_created_atTimeLabel == nil)
    {
        ...
        created_atTimeLabel.font = [UIFont systemFontOfSize:11];
...
- (UILabel *)sourceCreatLabel
{
    if(_sourceCreatLabel == nil)
    {
        ...
        sourceCreatLabel.font = [UIFont systemFontOfSize:11];
